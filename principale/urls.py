...
urlpatterns = [
    ...
    path('locations/<int:location_id>/cloturer/', views.cloturer_location, name='cloturer_location'),
    path('locations/<int:location_id>/annuler-cloture/', views.annuler_cloture_location, name='annuler_cloture_location'),
    ...
    path('locations/<int:location_id>/revisions/ajouter/', views.ajouter_revision_loyer, name='ajouter_revision_loyer'),
    path('revisions/<int:revision_id>/modifier/', views.modifier_revision_loyer, name='modifier_revision_loyer'),
    path('revisions/<int:revision_id>/supprimer/', views.supprimer_revision_loyer, name='supprimer_revision_loyer'),
